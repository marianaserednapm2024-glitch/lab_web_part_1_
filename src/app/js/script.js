document.addEventListener('DOMContentLoaded', () => {
    ...
    const skills = [
        ...
        { name: "Microsoft Word", value: 90 },
        { name: "Microsoft PowerPoint", value: 80 },
        { name: "HTML-5/CSS-3", value: 95 }
    ];

    const hobbies = [
        { name: "Book Reading", value: 70 },
        { name: "Travelling", value: 85 },
        { name: "Playing Chess", value: 60 },
        { name: "Painting", value: 75 },
    ...
    renderProgressItems(skills, "skillsContainer", "red");
    renderProgressItems(hobbies, "hobbiesContainer", "red");
    renderLanguageCircles(languages, ".pad-2 .row", "red");

    const sectionTitles = document.querySelectorAll('.section-title');

    sectionTitles.forEach(title => {
        const arrow = title.querySelector('.arrow'); // стрілка всередині заголовку
